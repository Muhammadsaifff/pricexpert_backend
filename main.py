...
from backend.database import models  # <-- ADD THIS LINE

# -------------------------------
# Create DB tables
# -------------------------------
print("Tables before init_db:", Base.metadata.tables.keys())  # Optional debug
init_db()
print("Tables after init_db:", Base.metadata.tables.keys())   # Optional debug
...
async def lifespan(app: FastAPI):
    logger.info("🚀 Starting PriceXpert API...")
